...
export default function PlannerHeader() {
  return (
    <div className="relative mb-6 flex flex-col justify-between gap-4 rounded-2xl border border-[#1E2D45] bg-[#0B132B]/80 p-5 backdrop-blur-md md:flex-row md:items-center">
      {/* Background SVG Mountain / Night Sky Aesthetic matching reference */}
      ...
      <div className="relative z-10 space-y-1">
        <div className="flex items-center gap-2 text-xs font-medium text-text-muted">
          <span>Dashboard</span>
          <span>&gt;</span>
          <span className="text-primary-400 font-semibold">Study Planner</span>
        </div>
        <h1 className="text-2xl font-extrabold tracking-tight text-white sm:text-3xl">
          Study Planner
        </h1>
        <p className="text-xs text-text-muted sm:text-sm">
          Plan smarter. Stay consistent. Achieve bigger.
        </p>
      </div>
      ...
      >
        <p className="text-xs italic text-blue-200">
          ...
          <br />
          builds your dream tomorrow.&rdquo;
        </p>
